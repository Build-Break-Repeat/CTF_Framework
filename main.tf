...
resource "docker_container" "windows_xp" {
  name   = "windows-xp"
  image  = docker_image.windows_xp.image_id
  memory = 2048
...
resource "docker_container" "windows_7" {
  name   = "windows-7"
  image  = docker_image.windows_7.image_id
  memory = 2048
...
resource "docker_container" "windows_2008" {
  name   = "windows-2008"
  image  = docker_image.windows_2008.image_id
  memory = 2048
